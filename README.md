...
- **No telemetry, tracking or analytics.** There is no telemetry, tracking or analytics code in Aggrega. The only network traffic is fetching the feeds and thumbnails you asked for; nothing is reported anywhere.
...
- **Click to read.** Clicking an article opens it in your default browser and marks it as read. Hover a story to toggle read/unread manually.
...
│   ├── thumbs.rs       # thumbnail download/resize/disk cache
